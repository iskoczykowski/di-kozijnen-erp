    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 lg:grid-cols-4">
        ...
        <div className="rounded-3xl bg-blue-50 p-6">
          <h2 className="text-xl font-black">{t('stock', lang)}</h2>
          <div className="mt-4 text-5xl">0</div>
        </div>

        <div className="rounded-3xl bg-green-50 p-6">
          <h2 className="text-xl font-black">{t('material', lang)}</h2>
          <div className="mt-4 text-5xl">0</div>
        </div>

        <div className="rounded-3xl bg-yellow-50 p-6">
          <h2 className="text-xl font-black">{t('location', lang)}</h2>
          <div className="mt-4 text-5xl">0</div>
        </div>

        <div className="rounded-3xl bg-red-50 p-6">
          <h2 className="text-xl font-black">{t('missing', lang)}</h2>
          <div className="mt-4 text-5xl">0</div>
        </div>
